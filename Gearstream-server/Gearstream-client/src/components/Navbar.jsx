...
const Navbar = () => {
  ...
  const navItems = (
    <>
      <li>
        <a className="text-deepblue" href="/">
          Home
        </a>
      </li>
      <li tabIndex={0}>
        <details>
          ...
          <ul className="p-2">
            ...
            <li>
              <a href="/menu">Camera</a>
            </li>
            <li>
              <a href="/menu">Lens</a>
            </li>
            <li>
              <a href="/menu">Lighting</a>
            </li>
            <li>
              <a href="/menu">Audio</a>
            </li>
      ...
      >
        ...
        <label
...

         {
          ...
          className="btn flex items-center gap-2 rounded-full px-6 bg-deepblue text-white"
        >
          <FaRegUser /> Log in
        </button>
         }
